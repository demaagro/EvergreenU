...
#[derive(Debug)]
pub struct EvergreenUIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EvergreenUIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EvergreenUI processing");
    
    let mut processor = EvergreenUIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EvergreenUIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EvergreenUIProcessor::new(false);
